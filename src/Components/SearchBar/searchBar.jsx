...
const SearchBar = ({ setSongs, songs }) => {
  ...
  const handleSearch = (event) => {
    ...
    let results = songs.filter((el) => {
      if (
        el.genre.toLowerCase().includes(searchCriteria) ||
        el.title.toLowerCase().includes(searchCriteria) ||
        el.artist.toLowerCase().includes(searchCriteria) ||
        el.album.toLowerCase().includes(searchCriteria) ||
